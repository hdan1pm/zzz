...
function pedido(props) {
    ...
    const leerServicio = (idcategoria) => {
        const rutaServicio = ApiWebURL + "pedidos.php?idpedido=" + idpedido
        fetch(rutaServicio)
    ...
    const leerProductoSeleccionado = (idproducto) => {
        const rutaServicio = ApiWebURL + "pedidoss.php?idpedido=" + idpedido
        fetch(rutaServicio)
            .then(response => response.json())
            .then(data => {
                console.log(data)
                    ...
                    <div className="col" key={item.idproducto}>
                        <div className="card text-center h-100"
                            ...
                            <i className="bi bi-eye icono-vista-rapida"
                                onClick={() => leerPedidoSeleccionado(item.idpedido)}
    ...
    return (
        <>
            ...
            <Pedidos codigoCategoria={categoriaSeleccionada.idcategoria}/>
